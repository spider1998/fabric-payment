...
docker exec cli peer channel create -o orderer0.blockchainrealestate.com:7050 -c assetschannel -f /etc/hyperledger/config/assetschannel.tx
...
docker exec cli peer chaincode instantiate -o orderer0.blockchainrealestate.com:7050 -C assetschannel -n blockchain-real-estate -l golang -v 1.0.0 -c '{"Args":["init"]}'
